...
class BuildLogicFunctionalTest {
    ...
    void testDependencies() {
        ...
        println result.output
        assert result.taskPaths(SUCCESS) == [':testDataDependencies']
    }
    ...
    void testProcessDataResources() {
        ...
        println result.output
        assert result.taskPaths(SUCCESS) == [':testProcessDataResources']
    ...
    void testWav() {
        ...
        println result.output
        assert result.taskPaths(SUCCESS) == [':wav']
        result = gradle.withArguments('testWav').build()
        println result.output
        assert result.taskPaths(SUCCESS) == [':testWav']
    }
    ...
    void testText() {
        ...
        println result.output
        assert result.taskPaths(SUCCESS) == [':text']
        result = gradle.withArguments('testText').build()
        println result.output
        assert result.taskPaths(SUCCESS) == [':testText']
    }
    ...
    void testLab() {
        ...
        println result.output
        assert result.taskPaths(SUCCESS) == [':lab']
        ...
        assert result.taskPaths(SUCCESS) == [':testLab']
    }
}
